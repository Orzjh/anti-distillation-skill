...
**沟通层面**：有人频繁询问"你会怎么处理X" / 被要求"总结你的工作方法论" / 需要提供"标准回复模板"

**文档层面**：被要求整理"知识文档" / 有人系统性地收集你的文档 / 被要求编写"工作手册"

**行为层面**：被邀请参与"知识管理项目" / HR 进行"经验传承"访谈 / 你的工作被过度记录

---

## 注意事项

* **原材料质量决定防御效果**：数据源越多，污染越全面
* 建议优先处理：**沟通记录** > **决策文档** > **技术方案**
